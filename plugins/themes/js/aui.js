...
!function (window) {
    ...
    Slider.prototype.onTouchEnd = function () {
		...
		//var tusrc= $('#banner-image' + shul).attr("data-bg_color");
		         var tusrc=_this.index.attr("data-bg_color");
		
				 $("#nheader").css("background","url("+tusrc+") #FFF no-repeat");
